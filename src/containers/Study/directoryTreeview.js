...
export default class DirectoryTreeView extends Component {
    ...
    constructor(props) {
        ...
        //if (this.props.dataList != null && this.props.dataList != undefined) {
        //    dataList = this.props.dataList;
        //}


        //const thisObj = this;
        //CallServerPost('Study/TreeViewDirectory', {}).then(
        //    function (response) {        
        //        //console.log(response);
        //        thisObj.setState({ ProtocolDocumentDataList: response});
        //    }).catch(error => error);   
    ...
    onTreeNodeSelect = (selectedKeys, e) => {
        ...
        /// set this selected node to the browser field
      //  this.props.handleFromParent(e.node.props); //,this.props.FileType
    };
