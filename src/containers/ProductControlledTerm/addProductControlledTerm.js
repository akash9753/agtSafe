...
class AddProductControlledTerm extends Component {
    ...
    constructor(props) {
        ...
        const thisObj = this;
        CallServerPost('ProductControlledTerm/GetProductControlledTermFormData', { FormName: "ProductControlledTerm", ActionName: "Create" }).then(
            function (response) {
    ...
    cancel = () => {
        ...
        this.props.history.push({
            pathname: '/trans/ProductControlledTerm'
        }
        );
    }
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                CallServerPost('ProductControlledTerm/Create', values)
                    .then(
                        function (response) {
...
const WrappedApp = Form.create()(AddProductControlledTerm);
