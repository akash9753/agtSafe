                        ...
                        <div style={{ height: "100%", width: "100%", display: "flex", flexDirection: "column" }}>
                            <Breadcrumb>
                                ...
                                <span style={{ float: 'right' }}>
                                        {(toHide != "left" && toHide != "both") && <Tooltip title="Prev"> <Icon type="caret-left" className={"defineRightLeftIcon"} theme="outlined" id='left' style={{ cursor: "pointer", fontSize: "20px" }} onClick={this.props.move} /></Tooltip>}
                                        {(toHide != "right" && toHide != "both") && <Tooltip title="Next"><Icon type="caret-right" className={"defineRightLeftIcon"} theme="outlined" id='right' style={{ cursor: "pointer", fontSize: "20px" }} onClick={this.props.move} /></Tooltip>}
                                    </span>
                                </Breadcrumb.Item>
                            </Breadcrumb>

                            <div style={{ overflow: "auto", height: "100%", display: "flex", flexDirection: "column" }}>
                                <SingleForm defineActivityWorkflowStatus={defineActivityWorkflowStatus} property={this} responseData={responseData} getFieldDecorator={getFieldDecorator}/* handleSubmit={this.handleValidate}*/ handleCancel={this.props.cancel ? this.Cancel : ""} isStudyLock={this.props.isStudyLock} />
