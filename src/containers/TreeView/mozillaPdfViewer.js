...
let thisObj = {};
export default class MozillaPdfViewer extends Component {
    constructor(props) {
        super(props);
        this.state = {
            numPages: null,
    ...
    componentDidMount() {
        return new Promise((resolve, reject) => {
            window.webViewerLoad(resolve, reject);
        }).then((result) => {

            window.loadMozPdf(this.props.fileName)
        }).catch(e => {
    ...
    render() {
        ...
        return (
            <LayoutContentWrapper id="fullScreenDiv" style={{ width: '100%', textAlign: '-webkit-center' }}>
                <div id="outerContainer">
                    <div id="sidebarContainer">
                        <div id="toolbarSidebar">
                            <div className="splitToolbarButton toggled">
                                <button id="viewThumbnail" className="toolbarButton" title="Show Thumbnails" tabIndex="2" data-l10n-id="thumbs">
                                    <i class="fa fa-folder" aria-hidden="true" style={{  marginTop: "-7px" }}></i>
                                ...
                                <button id="viewOutline" className="toolbarButton" title="Show Document Outline (double-click to expand/collapse all items)" tabIndex="3" data-l10n-id="document_outline">
                                    <i class="fa fa-clone" aria-hidden="true" style={{ marginTop: "-7px" }}></i>
                                </button>
                                    ...
                                    <input type="checkbox" id="findHighlightAll" className="toolbarField" tabIndex="94" />
                                        ...
                                        <div id="findbarOptionsTwoContainer">
                                            <input type="checkbox" id="findEntireWord" className="toolbarField" tabIndex="96" />
                                                <label for="findEntireWord" className="toolbarLabel" data-l10n-id="find_entire_word_label">Whole words</label>
                                            ...
                                            <div id="toolbarContainer">
                                                <div id="toolbarViewer">
                                                    <div id="toolbarViewerLeft">
                                                        ...
                                                        <i class="fa fa-server" aria-hidden="true" style={{ marginTop: "-7px" }}></i>
                                                        </button>
                                                        <div className="toolbarButtonSpacer"></div>
                                                        <button id="viewFind" title="Find in Document" className="toolbarButton" tabIndex="12" data-l10n-id="findbar">
                                                              <i class="fa fa-file" aria-hidden="true" style={{ marginTop: "-7px" }}></i>
                                                        </button>
                                                        <div className="splitToolbarButton hiddenSmallView">
                                                            <button className="toolbarButton pageUp" title="Previous Page" id="previous" tabIndex="13" data-l10n-id="previous">
                                                                   <i class="fa fa-arrow-left" aria-hidden="true" style={{ marginTop: "-7px" }}></i>
                                                           </button>
                                                            <div className="splitToolbarButtonSeparator"></div>
                                                            <button className="toolbarButton pageDown" title="Next Page" id="next" tabIndex="14" data-l10n-id="next">
                                                             <i class="fa fa-arrow-right" aria-hidden="true" style={{ marginTop: "-7px" }}></i>
                                                         </button>
                                                        </div>
                                                        <input type="number" id="pageNumber" className="toolbarField pageNumber" title="Page" value="1" size="4" min="1" tabIndex="15" data-l10n-id="page" autocomplete="off" />
                                                            <span id="numPages" className="toolbarLabel"></span>
                                                    </div>
                                                        <div id="toolbarViewerRight">
                                                            <button id="presentationMode" className="toolbarButton" title="Switch to Presentation Mode" tabIndex="31" data-l10n-id="presentation_mode">
                                                                <i class="fa fa-bars" aria-hidden="true" style={{ marginTop: "-7px" }}></i>
                                                            </button>

                                                              <button id="openFile" className="toolbarButton openFile hiddenLargeView" title="Open File" tabIndex="32" data-l10n-id="open_file" style={{ display: "none" }}>
                                                                <span data-l10n-id="open_file_label">Open</span>
                                                            </button>

                                                            <button id="print" className="toolbarButton print hiddenMediumView" title="Print" tabIndex="33" data-l10n-id="print" style={{ display: "none" }}>
                                                                <span data-l10n-id="print_label">Print</span>
                                                            </button>

                                                            <button id="download" className="toolbarButton download hiddenMediumView" title="Download" tabIndex="34" data-l10n-id="download" style={{ display: "none" }}>
                                                                <span data-l10n-id="download_label">Download</span>
                                                            </button>
                                                             <a href="#" id="viewBookmark" className="toolbarButton bookmark hiddenSmallView" title="Current view (copy or open in new window)" tabIndex="35" style={{display:"none"}} data-l10n-id="bookmark">
                                                                <span data-l10n-id="bookmark_label">Current View</span>
                                                             </a>

                                                            <div className="verticalToolbarSeparator hiddenSmallView"></div>
                                                                <button id="secondaryToolbarToggle" class="toolbarButton" title="Tools" tabindex="36" data-l10n-id="tools" aria-expanded="false" aria-controls="secondaryToolbar">
                                                                    <i class="fa fa-cog" onClick={(e) => e.stopPropagation()} aria-hidden="true" style={{ marginTop: "-7px" }}> </i>
                                                                </button>
                                                             </div>
                                                          <div id="toolbarViewerMiddle">
                                                            <div className="splitToolbarButton">
                                                                <button id="zoomOut" className="toolbarButton zoomOut" title="Zoom Out" tabIndex="21" data-l10n-id="zoom_out">
                                                                <i class="fa fa-minus" aria-hidden="true" style={{  marginTop: "-7px" }}></i>

                                                                </button>
                                                                <div className="splitToolbarButtonSeparator"></div>
                                                                <button id="zoomIn" className="toolbarButton zoomIn" title="Zoom In" tabIndex="22" data-l10n-id="zoom_in">
                                                                    <i class="fa fa-plus" aria-hidden="true" style={{  marginTop: "-7px" }}></i>
