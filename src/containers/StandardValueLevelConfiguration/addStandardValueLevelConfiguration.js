...
class AddStandardValueLevelConfiguration extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            editStandardValueLevelConfiguration: false,
            responseData: {
                formData: {},
                selectOptions: {}
            },
        ...
        const thisObj = this;
        CallServerPost('StandardValueLevelConfiguration/GetStandardValueLevelConfigurationFormData', { FormName: "StandardValueLevelConfiguration", ActionName: "Create" }).then(
            function (response) {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                CallServerPost('StandardValueLevelConfiguration/Create', values)
                    .then(
                    function (response) {
...
const WrappedApp = Form.create()(AddStandardValueLevelConfiguration);
