...
var _s = require('src/s3');

var _azure = require('src/azure');
...
describe('Fine Uploader wrapper classes', function () {
    ...
    describe('callback handling', function () {
        ...
        it('provides access to the entire qq namespace from wrapper instance', function () {
        ...
        it('provides access to the entire qq namespace from wrapper export', function () {
            expect(_traditional.qq.status.QUEUED).toBe('queued');
            expect(_s.qq.status.QUEUED).toBe('queued');
            expect(_azure.qq.status.QUEUED).toBe('queued');
        });
    });
});